...
Partial Public Class KasirDataSet
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/KasirDataSet.xsd"
    ...
    Partial Public Class tbl_barangDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function Addtbl_barangRow(ByVal KodeBarang As String, ByVal NamaBarang As String, ByVal Harga As Integer, ByVal Satuan As String) As tbl_barangRow
            Dim rowtbl_barangRow As tbl_barangRow = CType(Me.NewRow,tbl_barangRow)
            Dim columnValuesArray() As Object = New Object() {KodeBarang, NamaBarang, Harga, Satuan}
...
Namespace KasirDataSetTableAdapters
    ...
    Partial Public Class tbl_barangTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT KodeBarang, NamaBarang, Harga, Satuan FROM tbl_barang"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
